...
## Dependencies
QR is implemented in Python 3 and has the following dependencies:
...
```
## Example
The `example` directory contains a 10-taxon avian species tree with 1000 gene trees. The commands below show examples of different modes of running QR on this dataset.
